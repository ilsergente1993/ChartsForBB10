        ...
        ScrollView {
            ...
            Container {
                ...
                WebView {
                    ...
                    horizontalAlignment: HorizontalAlignment.Fill
                    verticalAlignment: VerticalAlignment.Fill
                    url: "local:///assets/html/radar.html" + (debugMode ? "?debug=true" : "")
                    ...
                    function createChart() {
                        ...
                        for (var i = 0; i < dd_num_datasets.selectedValue; i ++) {
                            datasets[i] = {
                                ...
                                backgroundColor: ExtFunction.randomColor(0.2),
                                borderColor: ExtFunction.randomColor(0.7),
                                pointBackgroundColor : ExtFunction.randomColor(0.8),
                                pointHighlightStroke : ExtFunction.randomColor(1),
                                pointBorderWidth: 1
                            }
                        }
